        ...
        <section>
                ...
                <div className='w-full bg-[#0A6847] opacity-95 py-10 lg:py-16 lg:px-16 md:px-10 px-10'>
                  <h1 className='text-shadow text-2xl lg:text-4xl leading-[60px] font-bold pb-0 lg:pb-10 flex justify-center align-center font-poppins text-white tracking-wider'>Hasil Nyata Inovasi Kami</h1> 
                    ...
                    <div className='max-w-[1200px] mx-auto xl:mx-auto lg:mx-36 grid md:grid-cols-2 md:border-none sm:border-b-2 px-0 xl:px-60 lg:px-20'>
                        ...
                        <img className='hidden w-[250px] h-[150px] lg:w-[350px] lg:h-[220px] border-yellow-400 mx-auto my-4 border-2 rounded-[50px] md:flex' data-aos='fade-left' src={Card2} alt="/" />
                    </div>
                ...
                <div className='hidden lg:block'>
                    <div className="w-full bg-white mt-[-30px] font-poppins">
                        ...
                        {weatherData && (
                            <div className="p-8 text-center mt-[-10px] mb-[-16rem]">
                            <h2 className="text-2xl font-bold text-green-800">{weatherData.name}</h2>
                            <h3 className="text-2xl font-semibold text-green-500">{weatherData.main.temp}°C</h3>
                            </div>
                        )}
