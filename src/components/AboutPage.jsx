  ...
  return (
      ...
      <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url(${bg1})` }}>
                ...
                <div data-aos="zoom-out">
                    ...
                    <p className="mt-4 text-lg md:text-2xl">Masa depan pertanian modern</p>
                ...
                <div className="absolute bottom-0 left-0 w-full h-1/2 bg-white rounded-tl-3xl rounded-tr-3xl px-10 py-6">
                    <div className="flex flex-col md:flex-row justify-center items-center py-6">
                        <div className="ml-0 lg:ml-28 max-w-2xl text-[#0A6847]">
                            <h1 className="text-center lg:text-start text-xl lg:text-5xl font-bold mb-6">Apa itu Fito Loka?</h1>
            ...
            <div className="hidden lg:block relative py-2 mt-10" style={{ backgroundImage: `url(${bg2})` }}>
             ...
             <div className="relative bg-[#0A6847] pt-20 pb-6 h-fit">
                 <div className="container mx-auto px-4 text-center">
                     <h2 className="text-xl text-white lg:text-2xl md:text-2xl font-bold mb-4 lg:mb-6">Mengapa Memilih Fito Loka?</h2>
                 </div>
                ...
                <div className="flex flex-col lg:flex-row max-w-7xl items-center justify-center py-8 mx-auto">
                     ...
                     <div className="px-4 text-white lg:ml-10">
                         <h1 className="text-xl lg:text-4xl font-bold mb-4 text-center lg:text-left">Hasil Maksimal, Pertanian Ideal</h1>
                         <p className="text-sm lg:text-2xl md:text-lg lg:leading-10 text-justify max-w-2xl lg:max-w-2xl">Dengan layanan pertanian modern dan produk yang ramah lingkungan, kami siap memberikan solusi yang efektif dan efisien untuk meningkatkan produktivitas lahan Anda. Bergabunglah bersama kami, nikmati kemudahan dalam setiap langkah bertani, dan rasakan perubahan nyata di lahan Anda. Bersama Fito Loka, menuju pertanian yang lebih baik dan berkelanjutan!</p>
                     </div>
