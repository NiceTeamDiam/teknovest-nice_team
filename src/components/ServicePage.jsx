...
const ServicePage = () => {
  ...
  const handleClick = () => {
    ...
    const message = "Halo! Saya tertarik dengan produk pupuk Fito Loka!"; // Pesan default
  ...
  return (
    <section className="font-poppins">
      ...
      <div className="relative h-fit py-6 xl:px-32">
        ...
        <div className="max-w-[1120px] flex flex-col md:flex-row py-10 px-10 mx-auto justify-center">
          <div
            className="w-full md:w-auto h-auto max-w-lg mx-auto"
            data-aos="fade-right">
            <img src={Igh} alt="" />
          </div>
          <div className="text-[#0A6847] w-full lg::max-w-5xl md:pl-20 md:px-2 py-5 md:py-16 text-center md:text-start items-center md:items-end">
            ...
            <div className="py-12">
              <a
                href="#"
                className="bg-[#07754E] text-white text-md md:text-lg font-semibold py-3 px-7 md:py-3 md:px-8 rounded-full transition-transform transform hover:scale-105 hover:text-[#07754E] hover:bg-white border border-transparent hover:border-[#07754E]">
                Coba Sekarang
              </a>
            </div>
          </div>
        ...
        <div className="flex flex-col-reverse md:flex-row pb-16 px-6 mx-auto">
          <div className="text-[#0A6847] w-full md:max-w-2xl md:pl-20 py-6">
            ...
            <div className="lg:px-0 text-justify pt-3">
